...
//    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        // set insets
        FrameLayout mainLayout = root.findViewById(R.id.top5ArtistsLayout);
...
//                            setNameonTitle();
    ...
    public void takeAndSaveScreenShot() {
        if (getActivity() != null) {
            ...
            currentActivity.findViewById(R.id.top5artistsexit).setVisibility(View.GONE);
            currentActivity.findViewById(R.id.T5Abottombar).setVisibility(View.GONE);
            currentActivity.findViewById(R.id.T5AHiddenSpacer).setVisibility(View.VISIBLE);
            ...
            new Handler(Looper.getMainLooper()).postDelayed(() -> {
                ...
                // Restore visibility
                currentActivity.findViewById(R.id.top5artistsexit).setVisibility(View.VISIBLE);
                currentActivity.findViewById(R.id.T5Abottombar).setVisibility(View.VISIBLE);
                currentActivity.findViewById(R.id.T5AHiddenSpacer).setVisibility(View.GONE);
