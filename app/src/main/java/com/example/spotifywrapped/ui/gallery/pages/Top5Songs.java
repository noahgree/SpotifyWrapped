...
//    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        // set insets
        FrameLayout mainLayout = root.findViewById(R.id.top5SongsLayout);
    ...
    private void addImageToGallery(Context context, Bitmap bitmap, String title, String description) {
        ...
        if (item != null) {
            ...
            ViewGroup rootView = (ViewGroup) ((ViewGroup) binding.getRoot().findViewById(R.id.top5SongsLayout)).getChildAt(0);
